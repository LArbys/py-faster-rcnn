...
from fast_rcnn.test import im_detect_rpn
...
NETS = {'rpn_uboone': ('trimese',
                       'rpn_uboone_trimese_rpn_stage1__stage1_iter_19500.caffemodel') }
...
def vis_detections(im, class_name, dets, image_name, thresh=0.5):
    ...
    im2 = im.copy()
    print "im2.shape is {}".format(im2.shape)
    ...
    for i in inds:
        ...
        ax.add_patch(
            plt.Rectangle((bbox[0], bbox[1]),
                          ...
                          edgecolor='red', linewidth=3.5,alpha=0.7)
        )
...
if __name__ == '__main__':
    ...
    cfg.TEST.BBOX_REG = False #dont test BBOX REG
    ...
    caffemodel = os.path.join(cfg.DATA_DIR, '/home/vgenty/py-faster-rcnn/output/faster_rcnn_alt_opt/rpn_uboone_train_1/',
