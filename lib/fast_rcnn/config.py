...
__C.TRAIN.USE_FLIPPED = False # hell no
...
# on zero-padding.
__C.TRAIN.ASPECT_GROUPING = False #one image size
...
__C.IMIN = 0.0
__C.IMAX = 1000.0
__C.IOCFG = "io_example.cfg"

#to be inserted by root_handler, this is a global pointer to IOManager wrapper
__C.RH = None
